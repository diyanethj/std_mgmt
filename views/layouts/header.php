    ...
    <div class="container">
        ...
        <nav>
            ...
            <?php elseif ($user['role'] === 'marketing_user'): ?>
                <a href="/std_mgmt/views/marketing/dashboard.php">Dashboard</a>
                <a href="/std_mgmt/views/marketing/assigned_leads.php">Assigned Leads</a>
                <a href="/std_mgmt/views/marketing/pending_registrations.php">Pending Registrations</a>
