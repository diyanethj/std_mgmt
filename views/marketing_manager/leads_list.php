...
if (!isset($pdo)) {
    error_log("PDO not defined in marketing_manager/leads_list.php");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['assign_lead'])) {
    ...
    if ($leadController->assignLead($lead_id, $user_id)) {
        header('Location: /std_mgmt/views/marketing_manager/leads_list.php?course=' . urlencode($course) . '&success=Lead%20assigned%20successfully');
        exit;
    } else {
    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-4 md:p-8">
            ...
            <div class="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-md">
                ...
                <p class="mb-6 text-gray-600">View and assign leads by course.</p>
                            ...
                            <tbody>
                                <?php foreach (array_unique(array_column($course_list, 'form_name')) as $course_name): ?>
                                    <tr class="border-b">
                                        ...
                                        <td class="p-3"><?php echo count($leadController->getLeadsByCourse($course_name)); ?></td>
                                        <td class="p-3">
                ...
                <?php if ($course && !empty($leads)): ?>
                    <h2 class="text-xl font-semibold mt-6 mb-4">Leads for <?php echo htmlspecialchars($course); ?></h2>
                    <div class="table-container">
                        <table class="w-full border-collapse bg-white">
                            <thead>
                                <tr class="bg-gray-100">
                                ...
                                <?php foreach ($leads as $lead): ?>
                                    <tr class="border-b">
                                        ...
                                        <td class="p-3">
                                            ...
                                            <?php else: ?>
                                                <form method="POST" action="/std_mgmt/views/marketing_manager/leads_list.php?course=<?php echo urlencode($course); ?>" class="space-y-2">
                                                    ...
                                                    <div class="form-group">
                                                        <select name="user_id" required class="mt-1 focus:ring-blue-500 focus:border-blue-500">
