...
if (!isset($pdo)) {
    error_log("PDO not defined in upload_leads.php");
    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-4 md:p-8">
            ...
            <div class="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-md">
                ...
                <?php endif; ?>
                <form method="POST" action="<?php echo BASE_PATH; ?>/admin/upload_leads" enctype="multipart/form-data" class="space-y-4">
                    <div class="form-group">
                        <label for="csv_file" class="block text-sm font-medium text-gray-700">Upload CSV File</label>
                        <input type="file" name="csv_file" id="csv_file" accept=".csv" required class="mt-1 block w-full p-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                    </div>
