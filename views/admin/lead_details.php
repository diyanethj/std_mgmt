...
<a href="/std_mgmt/views/admin/<?php echo $lead['status'] === 'registered' ? 'registered_leads.php?course=' . urlencode($lead['form_name']) : 'assigned_leads.php?course=' . urlencode($lead['form_name']); ?>" class="btn btn-primary">Back</a>
