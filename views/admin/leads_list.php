...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['assign_lead'])) {
    ...
    if ($leadController->assignLead($lead_id, $user_id)) {
        header('Location: /std_mgmt/views/admin/leads_list.php?course=' . urlencode($course) . '&success=Lead assigned successfully');
        exit;
    } else {
    ...
    <table class="table">
        ...
        <tr>
            ...
            <td>
                ...
                <?php else: ?>
                    <form method="POST" action="/std_mgmt/views/admin/leads_list.php?course=<?php echo urlencode($course); ?>">
