...
<form method="GET" action="/std_mgmt/views/academic_user/pending_registrations.php">
    ...
    <table class="table">
        ...
        <tr>
            ...
            <td>
                ...
                <a href="/std_mgmt/views/academic_user/lead_details.php?lead_id=<?php echo htmlspecialchars((string)$registration['lead_id']); ?>" class="btn btn-primary">View Details</a>
            </td>
        </tr>
        <?php endforeach; ?>
    </table>
