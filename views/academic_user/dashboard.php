            ...
            <div class="max-w-4xl mx-auto bg-white/80 backdrop-blur-md p-6 rounded-xl shadow-xl">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-6">
                    ...
                    <div class="bg-gradient-to-br from-blue-100 to-blue-200 p-4 rounded-xl text-center shadow-lg hover:shadow-2xl transition-all duration-300">
                        <h3 class="text-lg font-semibold text-blue-800">Declined Registrations</h3>
                ...
                <div class="flex flex-wrap gap-4">
                    ...
                    <a href="<?php echo BASE_PATH; ?>/views/academic_user/registered_leads.php" class="px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg hover:from-blue-700 hover:to-blue-800 shadow-md hover:shadow-lg transition-all duration-300">View Registered Students</a>
                    <a href="<?php echo BASE_PATH; ?>/views/academic_user/declined_leads.php" class="px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg hover:from-blue-700 hover:to-blue-800 shadow-md hover:shadow-lg transition-all duration-300">View Declined Registrations</a>
                </div>
            </div>
        </div>
    </div>
