...
<table class="table">
    ...
    <tr>
        ...
        <td><a href="/std_mgmt/views/academic/pending_registrations.php?lead_id=<?php echo htmlspecialchars($registration['lead_id']); ?>" class="btn btn-primary">View Details</a></td>
    </tr>
    <?php endforeach; ?>
</table>
